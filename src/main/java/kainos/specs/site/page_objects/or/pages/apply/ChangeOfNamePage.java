...
public class ChangeOfNamePage extends Site {
    ...
    @FindBy(id = "nameChangeReason-marriage-label")
    private WebElement nameChangeReasonMarriageButton;
    @FindBy(id = "nameChangeReason-divorce-label")
    private WebElement nameChangeReasonDivorcedButton;
    @FindBy(id = "nameChangeReason-gender-label")
    private WebElement nameChangeReasonGenderReassignmentButton;
    @FindBy(id = "nameChangeReason-other-label")
    private WebElement nameChangeReasonOtherButton;
