...
public class ContactPreferencesPage extends Site {
    ...
    @FindBy(tagName = "h1") private WebElement contactPreferencesPageHeader;
    @FindBy(id = "contactPrefsEmail-label") private WebElement emailContactButton;
    @FindBy(id = "contactPrefsSMS") private WebElement smsContactButton;
    @FindBy(id = "dialling-code-sms") private WebElement diallingCodeSMSField;
    @FindBy(id = "mobilePhone") private WebElement contactMobilePhoneField;
