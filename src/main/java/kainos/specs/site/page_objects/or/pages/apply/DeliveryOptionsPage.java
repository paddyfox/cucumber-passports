...
public class DeliveryOptionsPage extends Site {
    ...
    @FindBy(tagName = "h1")
    private WebElement deliveryOptionsPageHeader;
    @FindBy(id = "secureDelivery-false-label")
    private WebElement standardDeliveryButton;
    @FindBy(id = "secureDelivery-true-label")
    private WebElement secureDeliveryButton;
