...
public class MaternalGrandparentsDetailsPage extends Site {
    ...
    @FindBy(tagName = "h1")
    private WebElement maternalGrandparentsDetailsPageHeader;
    @FindBy(id = "parent1-parent1-first-name")
    private WebElement maternalGrandParentOneFirstNameField;
    @FindBy(id = "parent1-parent1-last-name")
    private WebElement maternalGrandParentOneLastNameField;
    @FindBy(id = "parent1-parent1-date-of-birth-day")
    private WebElement dobDayFieldMaternalGrandParentOne;
    @FindBy(id = "parent1-parent1-date-of-birth-month")
    private WebElement dobMonthFieldMaternalGrandParentOne;
    @FindBy(id = "parent1-parent1-date-of-birth-year")
    private WebElement dobYearFieldMaternalGrandParentOne;
    @FindBy(id = "parent1-parent2-first-name")
    private WebElement maternalGrandParentTwoFirstNameField;
    @FindBy(id = "parent1-parent2-last-name")
    private WebElement maternalGrandParentTwoLastNameField;
    @FindBy(id = "parent1-parent2-date-of-birth-day")
    private WebElement dobDayFieldMaternalGrandParentTwo;
    @FindBy(id = "parent1-parent2-date-of-birth-month")
    private WebElement dobMonthFieldMaternalGrandParentTwo;
    @FindBy(id = "parent1-parent2-date-of-birth-year")
    private WebElement dobYearFieldMaternalGrandParentTwo;
    @FindBy(id = "parent1-parents-marriage-date-day")
    private WebElement marriageDateDayMaternalGrandParentsField;
    @FindBy(id = "parent1-parents-marriage-date-month")
    private WebElement marriageDateMonthMaternalGrandParentsField;
    @FindBy(id = "parent1-parents-marriage-date-year")
    private WebElement marriageDateYearMaternalGrandParentsField;
    @FindBy(id = "parent1-parent1-town-of-birth")
    private WebElement maternalGrandParentOneTownOfBirthField;
    @FindBy(id = "parent1-parent2-town-of-birth")
    private WebElement maternalGrandParentTwoTownOfBirthField;
    @FindBy(id = "parent1-parent1-country-of-birth")
    private WebElement maternalGrandmotherCountryOfBirthDropdown;
    @FindBy(id = "parent1-parent2-country-of-birth")
    private WebElement maternalGrandfatherCountryOfBirthDropdown;
    @FindBy(id = "parent1-parents-married-true-label")
    private WebElement yesForMyParentOnesParentsMarriedOrInCivilPartnership;
    @FindBy(id = "parent1-parents-married-false-label")
    private WebElement noForMyParentOnesParentsMarriedOrInCivilPartnership;
    @FindBy(css = "#parent1-parent1-reason-reveal > summary > span")
    private WebElement cantProvideMaternalGrandMotherDetailsLink;
    @FindBy(css = "#parent1-parent1-reason-reveal")
    private WebElement cantProvideMaternalGrandMotherDetailsLinkEdit;
    @FindBy(css = "#parent1-parent2-reason-reveal > summary > span")
    private WebElement cantProvideMaternalGrandFatherDetailsLink;
    @FindBy(css = "#parent1-parent2-reason-reveal")
    private WebElement cantProvideMaternalGrandFatherDetailsLinkEdit;
    @FindBy(id = "parent1-parent1-no-details-reason")
    private WebElement insertReasonForMaternalGrandMotherField;
    @FindBy(id = "parent1-parent2-no-details-reason")
    private WebElement insertReasonForMaternalGrandFatherField;
