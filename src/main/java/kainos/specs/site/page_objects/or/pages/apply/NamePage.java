...
public class NamePage extends Site {
    ...
    @FindBy(tagName = "h1") private WebElement namePageHeader;
    @FindBy(id = "title-Mr-label") private WebElement mrButton;
    @FindBy(id = "title-Ms-label") private WebElement msButton;
    @FindBy(id = "title-Mrs-label") private WebElement mrsButton;
    @FindBy(id = "title-Other-label") private WebElement otherButton;
    @FindBy(id = "title-Master-label") private WebElement masterButton;
    @FindBy(id = "title-Miss-label") private WebElement missButton;
    @FindBy(id = "otherTitle") private WebElement otherTitleField;
    @FindBy(id = "firstName") private WebElement firstNameField;
    @FindBy(id = "lastName") private WebElement lastNameField;
    @FindBy(id = "changeOfName-true-label") private WebElement sameNameNoButton;
    @FindBy(id = "changeOfName-false-label") private WebElement sameNameYesButton;
