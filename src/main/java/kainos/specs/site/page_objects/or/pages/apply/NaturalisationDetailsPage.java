...
public class NaturalisationDetailsPage extends Site {
    ...
    @FindBy(tagName = "h1")
    private WebElement naturalisationDetailsPageHeader;
    @FindBy(id = "naturalisationCertificateNumber")
    private WebElement certificateNumberField;
    @FindBy(id = "naturalisationIssueDate-day")
    private WebElement issueDateDayField;
    @FindBy(id = "naturalisationIssueDate-month")
    private WebElement issueDateMonthField;
    @FindBy(id = "naturalisationIssueDate-year")
    private WebElement issueDateYearField;
    ...
    public void completeForm(String certificateNumber, String naturalisationDate, String applicationType) {
