...
public class PreviousNamePage extends Site {
    ...
    @FindBy(tagName = "h1")
    private WebElement previousNamePageHeader;
    @FindBy(className = "govuk-fieldset__heading")
    private WebElement otherNamesPageHeader;
    @FindBy(id = "previous-names-false-label")
    private WebElement otherNameNoButton;
    @FindBy(id = "previous-names-true-label")
    private WebElement otherNameYesButton;
    @FindBy(id = "previousFirstName1")
    private WebElement previousFirstNameMiddleNameField0;
    @FindBy(id = "previousLastName1")
    private WebElement previousLastNamesField0;
