...
public class SARDetailsPage extends Site {
    ...
    @FindBy(tagName = "h1") private WebElement sarPageHeader;
    @FindBy(id = "canSign-true-label") private WebElement iCanSignInButton;
    @FindBy(id = "canSign-false-label") private WebElement iCantSignInButton;
    @FindBy(id = "noSignReason") private WebElement insertReasonField;
