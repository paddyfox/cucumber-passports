...
public class WhoIsThisPassportForPage extends Site {
    ...
    @FindBy(tagName = "h1") private WebElement whoIsThisPassportForPageHeader;
    @FindBy(id = "thirdParty-false-label") private WebElement meButton;
    @FindBy(id = "thirdParty-true-label") private WebElement someoneElseButton;
