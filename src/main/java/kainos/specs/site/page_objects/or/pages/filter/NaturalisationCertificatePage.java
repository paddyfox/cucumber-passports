...
public class NaturalisationCertificatePage extends Site {
    ...
    @FindBy(id = "naturalised-true-label")
    private WebElement yesNaturalisationCertificateButton;
    @FindBy(id = "naturalised-false-label")
    private WebElement noNaturalisationCertificateButton;
