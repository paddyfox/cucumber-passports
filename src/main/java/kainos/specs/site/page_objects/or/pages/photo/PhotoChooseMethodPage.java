...
public class PhotoChooseMethodPage extends Site {
    ...
    private WebElement choosePhotoMethodPageHeader;
    @FindBy(id = "photoMethod-digitalphoto-label")
    private WebElement iHaveADigitalPhotoToUploadRadio;

    public void verifyPageHeader() throws Exception {
        verifyHeaderBilingual(PAGE_HEADER_WELSH, PAGE_HEADER_ENGLISH, choosePhotoMethodPageHeader);
    }

    public void selectIHaveADigitalPhotoToUpload() {
        clickOnElement(iHaveADigitalPhotoToUploadRadio);
    }
}
